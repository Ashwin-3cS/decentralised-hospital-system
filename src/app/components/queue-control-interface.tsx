  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <Button onClick={handleNextPatient} className="bg-black text-white hover:bg-gray-800">
          Next Patient
        </Button>
      ...
      <Button onClick={handleEmergencyOverride} className="w-full bg-[#D32F2F] text-white hover:bg-red-700">
