...
const medicalRecords = [
  { id: 1, provider: 'City Hospital', date: '2023-06-01', type: 'Lab Results' },
  { id: 2, provider: 'County Clinic', date: '2023-05-15', type: 'Prescription' },
  { id: 3, provider: 'MedPharm', date: '2023-05-10', type: 'Vaccination' },
]
