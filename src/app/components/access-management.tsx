...
const initialPermissions = [
  { id: 'A1', patientId: 'P12345', lastAccessed: '2023-06-10 14:30', expiresIn: '2 days' },
  { id: 'A2', patientId: 'P67890', lastAccessed: '2023-06-09 09:15', expiresIn: '5 days' },
]

const initialRequestHistory = [
  { id: 'R1', patientId: 'P12345', timestamp: '2023-06-08 11:20', status: 'Approved' },
  { id: 'R2', patientId: 'P67890', timestamp: '2023-06-07 16:45', status: 'Pending' },
  { id: 'R3', patientId: 'P24680', timestamp: '2023-06-06 10:30', status: 'Rejected' },
]

export function AccessManagement() {
  const [activePermissions, setActivePermissions] = useState(initialPermissions)
