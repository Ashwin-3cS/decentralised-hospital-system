...
const features = [
  {
    ...
    description: "Your medical data is encrypted and only accessible with your permission."
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description: "View a complete, immutable history of all data access and changes."
  }
]
