...
export function RequestAccessPanel() {
  ...
  const [requests, setRequests] = useState<Request[]>([
    { id: 'R1', patientId: 'P12345', status: 'pending', timestamp: '2023-06-10 14:30' },
    { id: 'R2', patientId: 'P67890', status: 'approved', timestamp: '2023-06-09 09:15' },
    { id: 'R3', patientId: 'P24680', status: 'rejected', timestamp: '2023-06-08 11:20' },
  ])
      ...
      <div>
        ...
        {requests.map((request) => (
          <div key={request.id} className="bg-gray-100 p-4 rounded-md mb-2">
            ...
            <p className="text-sm text-gray-600">Timestamp: {request.timestamp}</p>
